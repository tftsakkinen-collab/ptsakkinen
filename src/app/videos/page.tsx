...
import { PlayCircle, Search, Sparkles, Layers } from "lucide-react";
...
export default function VideoLibraryPage() {
  ...
  // Group videos by category for the 3 distinct sections
  ...
  return (
    <div className="py-12 md:py-20 bg-[#000a18] min-h-screen text-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Dynamic Display Mode: Grouped into 3 Sections if 'Kaikki' selected, else Single Grid */}
