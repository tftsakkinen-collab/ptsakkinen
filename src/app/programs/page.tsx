        ...
        <div className="max-w-4xl mx-auto p-8 rounded-3xl bg-[#000d21] border border-[#0C66B4]/40 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-300">
            <div className="space-y-2 p-4 rounded-xl bg-[#014489]/20 border border-[#0C66B4]/30">
              <h3 className="font-bold text-white">How long do I have access to the program?</h3>
              <p className="text-xs leading-relaxed">
                You receive lifetime digital access, allowing you to progress completely at your own pace.
              </p>
            </div>
            ...
            <div className="space-y-2 p-4 rounded-xl bg-[#014489]/20 border border-[#0C66B4]/30">
              ...
              <p className="text-xs leading-relaxed">
                No. These programs provide physical rehabilitation guidance and complement your existing dental or medical care.
              </p>
            </div>
          </div>
        </div>
