      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-6">
            All the equipment, cameras, audio gear, rehab tools, and software I use for content creation and coaching.
          </p>
          ...
          <div className="p-4 rounded-xl bg-[#000d21]/90 border border-[#0C66B4]/50 text-left text-xs text-gray-300 flex items-start gap-3 shadow-lg">
            ...
            <div>
              ...
              Some of the links on this page are affiliate links. Purchasing through these links incurs no extra cost to you, but provides a small commission that helps support free content creation!
            </div>
          </div>
        </div>
