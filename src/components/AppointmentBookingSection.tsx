      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-3">
          ...
          <h2 className="text-3xl sm:text-5xl font-display text-white tracking-wide">
            HOW DO I <span className="text-[#67e8f9]">BOOK AN APPOINTMENT?</span>
          </h2>
          ...
          <div className="p-7 rounded-3xl bg-[#000d21] border border-[#0C66B4]/60 space-y-4 shadow-panel hover:border-[#00AEEF] transition-all flex flex-col justify-between text-center items-center">
            <div className="space-y-4 w-full flex flex-col items-center">
              <div className="flex flex-col items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-[#00AEEF]/20 text-[#67e8f9] flex items-center justify-center font-bold">
                  <Building2 className="w-6 h-6" />
                </div>
                <span className="text-[11px] font-mono text-[#67e8f9] bg-[#014489]/30 px-3 py-1 rounded-full border border-[#00AEEF]/30">
                  Oulu &amp; Online
                </span>
              </div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 text-xs font-bold text-[#67e8f9] hover:underline pt-3 border-t border-[#0C66B4]/30 w-full text-center"
            >
        ...
        <div className="p-6 rounded-2xl bg-[#000d21] border border-[#0C66B4]/30 text-center space-y-2">
          <p className="text-xs text-gray-300">
            For corporate workshops and university lecture inquiries, contact directly via email: <a href="mailto:tiedottajanne@gmail.com" className="text-[#67e8f9] hover:underline font-bold">tiedottajanne@gmail.com</a> or phone: <a href="tel:+358413274967" className="text-[#67e8f9] hover:underline font-bold">+358 41 327 4967</a>.
          </p>
        </div>
      </div>
    </section>
