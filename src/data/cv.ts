...
export const CV_DATA_EN = {
  ...
  certifications: [
    ...
    { title: "Physical Therapy for TMJ & Orofacial Disorders", instructorOrOrg: "Tuija Mänttäri, SOMTY", year: "2015" },
    { title: "MET Technique (Cervical, Thoracic & Lumbar Spine)", instructorOrOrg: "Darren Higgins", year: "2014" },
